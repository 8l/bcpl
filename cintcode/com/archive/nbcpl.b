...
//writef("trying: GET *"%s*" in BCPLHDRS*n", charv)
  // First look in the current directory
  stream := pathfindinput(charv, "NBCPLHDRS")
...
//sawritef("trying: GET *"%s*" in BCPLHDRS*n", filename)
    stream := pathfindinput(filename, "NBCPLHDRS")  // MR 18/2/04
  }
