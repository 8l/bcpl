...
//static unsigned char* in, *out, state[4][4];
...
LET KeyExpansion() = VALOF
{
  ...
  Rkey%00, Rkey%01, Rkey%02, Rkey%03 := key%00, key%01, key%02, key%03
  Rkey%10, Rkey%11, Rkey%12, Rkey%13 := key%10, key%11, key%12, key%13
  Rkey%20, Rkey%21, Rkey%22, Rkey%23 := key%20, key%21, key%22, key%23
  Rkey%30, Rkey%31, Rkey%32, Rkey%33 := key%30, key%31, key%32, key%33

  // All other round keys are found from the previous round keys.
  //for(; (i < (Nb * (Nr + 1))); ++i)
  FOR i = 4 TO 40 BY 4 DO
  { LET Pkey = @Rkey!(i-4)
    LET Nkey = @Rkey!i
    //for(j = 0; j < 4; ++j)
    //{
    ...
    //}
    LET tmp00, tmp01, tmp02, tmp03 := Pkey%00, Pkey%01, Pkey%02, Pkey%03
    LET tmp10, tmp11, tmp12, tmp13 := Pkey%10, Pkey%11, Pkey%12, Pkey%13
    LET tmp20, tmp21, tmp22, tmp23 := Pkey%20, Pkey%21, Pkey%22, Pkey%23
    LET tmp30, tmp31, tmp32, tmp33 := Pkey%30, Pkey%31, Pkey%32, Pkey%33
    ...
    Nkey%00, Nkey%01, Nkey%02, Nkey%03 := Pkey%00 XOR tmp00, Pkey%01, Pkey%02, Pkey%03
    Nkey%10, Nkey%11, Nkey%12, Nkey%13 := Pkey%10, Pkey%11, Pkey%12, Pkey%13
    Nkey%20, Nkey%21, Nkey%22, Nkey%23 := Pkey%20, Pkey%21, Pkey%22, Pkey%23
    Nkey%30, Nkey%31, Nkey%32, Nkey%33 := Pkey%30, Pkey%31, Pkey%32, Pkey%33
  }
}
