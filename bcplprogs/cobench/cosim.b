...
//^1
  IF argv!0 & string_to_number(argv!0) DO nodes    := result2 // -k
//   ^1       ^0                          ^0
  IF argv!1 & string_to_number(argv!1) DO stoptime := result2 // -s
//   ^1       ^0                          ^0
  IF argv!2 & string_to_number(argv!2) DO ptmax    := result2 // -p
//   ^1       ^0                          ^0
  IF argv!3 & string_to_number(argv!3) DO seed     := result2 // -r
//   ^1       ^0                          ^0
  tracing := argv!4                                           // -t
//^1
